...
public class Discord {
    ...
    public static String cmdCountingGame = "countinggame";
    ...
    private static void registerCommands() {
        ...
        bot.upsertCommand(cmdCountingGame, "Erstellt einen Zähl Game Channel und Startet das Game!").addOption(OptionType.STRING, cmdCountingGameChannelName, "TextChanel Name für den Game Channel", true).queue();
        bot.upsertCommand(cmdDeleteCountingGame, "Löscht den Zähl Game Channel!").queue();
